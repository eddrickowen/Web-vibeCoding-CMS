    ...
    <section id="about" className="about section-pad">
      <div className="container">
        ...
        <div className="about-statement" ref={statementRef}>
          <div className="line-wrap"><p className="display-lg hero-line-inner">{line1}</p></div>
          <div className="line-wrap"><p className="display-lg hero-line-inner">{line2}</p></div>
          <div className="line-wrap"><p className="display-lg hero-line-inner is-accent">{line3}</p></div>
        </div>
        <div className="about-body">
          <div data-reveal data-reveal-delay="1"><p className="body-text">{para1}</p></div>
          <div data-reveal data-reveal-delay="2"><p className="body-text">{para2}</p></div>
        </div>
      </div>
    </section>
  )
