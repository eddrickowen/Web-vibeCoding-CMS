...
export default function Contact({ data = {}, siteSettings = {} }: { data?: any; siteSettings?: any }) {
  ...
  return (
    <section id="contact" className="contact section-pad">
      <div className="container contact-inner">
        ...
        <h2 className="display-xl contact-title" ref={titleRef} aria-label={`${line1} ${line2}`}>
        ...
        <div className="contact-cta" data-reveal data-reveal-delay="3">
          <a href={`mailto:${email}`} className="btn btn--primary btn--lg" data-magnetic>
            {buttonText}
          </a>
        </div>
        <div className="contact-meta" data-reveal data-reveal-delay="4">
          <a href={`mailto:${email}`} className="contact-email mono-sm">{email}</a>
