...
export default function Hero({ data = {} }) {
  ...
  // GSAP: hero line reveal + parallax
  useEffect(() => {
  ...
  return (
    <section id="hero" className="hero" aria-label="Hero">
      ...
      <div className="hero-content" ref={contentRef}>
        ...
        <span className="label hero-label" data-reveal>
          {label}
        </span>

        <h1 className="display-xl hero-title" aria-label={`${line1} ${line2} ${line3}`}>
          <span className="line-wrap">
            <span className="hero-line-inner">{line1}</span>
          </span>
          <span className="line-wrap">
            <em className="hero-line-inner">{line2}</em>
          </span>
          <span className="line-wrap">
            <span className="hero-line-inner">{line3}</span>
          </span>
        </h1>
        ...
        <div className="hero-ctas">
          <a href="#artists" className="btn btn--primary" data-magnetic>
            {cta1Text}
          </a>
